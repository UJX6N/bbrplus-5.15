# bbrplus-5.15
Linux BBRplus Kernel 5.15 ported from BBRplus 4.14  
(note that it does NOT based on 5.15 version of BBR, instead just simple ported the 4.14 version of BBRplus)
<br/>
<br/>
<br/>
...
###  ii)  keep official v5.15 tcp_bbr module in the kernel, now can do either  
<br/>
...
### 1) get convert patch on this repository, use git or direct download
        (e.g., convert_official_linux-5.15.x_src_to_bbrplus.patch)
...
### 2) download officaial linux kernel
        say 5.15.11       
            wget https://cdn.kernel.org/pub/linux/kernel/v5.x/linux-5.15.11.tar.gz

<br/>
<br/>

### 3) extract the tarball & cd extracted directory
        tar zxvf linux-5.15.11.tar.gz && cd linux-5.15.11
...
### 4) copy convert patch to extracted kernel directory
        something like
            cp ../convert_official_linux-5.15.x_src_to_bbrplus.patch .
